      ...
      <View style={styles.blurWrapper}>
        ...
        >
          ...
          {state.routes.map((route: any, index: number) => {
            ...
            // Home button - Soft cream with glow
            if (route.name === 'Home') {
              return (
                <Animated.View
                  key={route.key}
                ...
                >
                  ...
                  >
                    <LinearGradient
                      ...
                      style={[
                        styles.homeButton,
                        isFocused && styles.homeButtonGlow,
                      ]}
                    >
                      <Ionicons
                      ...
                      />
                      <Text style={styles.homeButtonLabel}>{t(tab.labelKey)}</Text>
                    </LinearGradient>
                  </TouchableOpacity>
                </Animated.View>
              );
            ...
            // Invite and Profile - Circular with soft cream when active
            return (
              <Animated.View
                key={route.key}
                style={[{ transform: [{ scale: scaleAnim }] }]}
